			...
			<!-- Header -->
				<div id="header-wrapper">
					<header id="header" class="container">
						...
						<!-- Logo -->
							<div id="logo">
								<h1><a href="index.html">CalcEasy</a></h1>
								<span>для риелтеров и юристов</span>
							</div>
								...
								<ul>
									...
									<li>
										...
										<ul>
											...
											<li><a href="#">Расчёт завышения</a></li>
										</ul>
									</li>
								</ul>
							</nav>
					...
					<div id="banner" class="box container">
						<div class="row">
							<div class="col-7 col-12-medium">
								<h2>Наши калькуляторы</h2>
								<p>Выберете интересующий вас сервис.</p>
								<input type="number" step="0.01" id="enter"/>
							</div>
							<div class="col-5 col-12-medium">
								<ul>
									<li><a href="#" class="button large icon solid fa-arrow-circle-right">Расчёт услуг</a></li>
									<li><a href="#" class="button alt large icon solid fa-question-circle">Расчёт завышения</a></li>
								</ul>
							</div>
						</div>
					</div>
